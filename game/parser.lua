...
function parse(words, dir, no_verb_cond)
  ...
  local units = {}
  local verbs = {}
  while words[1].type and (words[1].type.anti or words[1].type.object or words[1].type.cond_prefix or words[1].type.parenthesis) or (words[2] and ((words[2].name == "txt" or words[2].name == "txtn't" or words[2].name == "!txt") or (words[2].type.gang and (words[1].type.object or words[1].type.gang_prefix) and not words[1].name:starts("txt_") and not (words[1].name:ends("n't") or words[1].name:starts("!"))))) do
    ...
    if words[1].type and words[1].type["and"] and words[2] and (words[2].type.object or words[2].type.parenthesis or (words[3] and ((words[3].name == "txt" or words[3].name == "txtn't" or words[3].name == "!txt") or (words[3].type.gang and (words[2].type.object or words[2].type.gang_prefix) and not words[2].name:starts("txt_") and not (words[2].name:ends("n't") or words[2].name:starts("!")))))) then
...
function findUnit(words, extra_words_, dir, outer, no_verb_cond, is_subject)
  ...
  do
    ...
    if nt then
      if prefix.name:ends("n't") or prefix.name:starts("!") then
  ...
  do
    ...
    if infix.type.cond_infix_verb then
      ...
      if nt then
        if infix.name:ends("n't") or infix.name:starts("!") then
...
function findClass(words, extra_words_)
  ...
  elseif words[2] and words[2].type.gang and (words[1].type.object or words[1].type.gang_prefix) and not words[1].name:starts("txt_") and not words[1].name:ends("n't") then
    ...
    local subset_name = (unit.name:ends("n't") or unit.name:starts("!")) and unit.name:sub(1, -4) or unit.name
    ...
    new_group = {(unit.name:ends("n't") or unit.name:starts("!")) and unit.name:sub(1, -4) or unit.name, subset_name}
  elseif not (words[1].type.object or words[1].type.indefinite_pronoun) then
    return nil
  end
  ...
  if nt then
    if (unit.name:ends("n't") or unit.name:starts("!")) then
